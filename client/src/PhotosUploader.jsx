        ...
        {addedPhotos &&
          ...
          addedPhotos.map((link) => (
            ...
            >
              ...
              <button
                onClick={(ev) => selectMainPhoto(link, ev)}
                className="absolute bottom-1 left-1 text-white bg-black bg-opacity-50 rounded-xl py-2 px-3 cursor-pointer"
              >
                {link === addedPhotos[0] && (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
